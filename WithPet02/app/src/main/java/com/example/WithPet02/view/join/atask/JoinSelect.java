...
// 중복검사 AsyncTask
public class JoinSelect extends AsyncTask<Void, Void, String> {

    String type;    // 검사할 컬럼
    String check;   // 검사할 값
    String result;

    public JoinSelect(String type, String check) {
        this.type = type;
        this.check = check;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/app/anJoinSelect";
            ...
            Log.d("main:JoinSelect", result);

            inputStream.close();

        } catch (Exception e){
            Log.d("main:JoinSelect", e.getMessage());
            e.printStackTrace();
        } finally {
            if(httpEntity != null){
                httpEntity = null;
