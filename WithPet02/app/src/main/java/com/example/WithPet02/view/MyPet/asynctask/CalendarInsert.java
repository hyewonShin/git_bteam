...
public class CalendarInsert extends AsyncTask<Void, Void, Void> {
    private String tel;
    private int year;
    private int month;
    private int date;
    ...
    //생성자초기화
    public CalendarInsert (String tel, int year, int month, int date, String content) {
        this.tel = tel;
        this.year = year;
        this.month = month;
        this.date = date;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            builder.addTextBody("content", String.valueOf(content), ContentType.create("Multipart/related", "UTF-8"));

            // /app = 앱이름, 서버에서 부를 때 사용
            String postURL = ipConfig + "/app/anCalendarInsert";
