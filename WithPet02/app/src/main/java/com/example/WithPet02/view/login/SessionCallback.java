        ...
        UserManagement.getInstance().me(new MeV2ResponseCallback() {
            ...
            public void onSuccess(MeV2Response result) {
                ...
                if(loginDTO == null) {
                    ...
                    //내 정보 페이지에서 호출
                    MySnsUpdate mySnsUpdate = new MySnsUpdate(loginDTO.getM_tel(), kakaoId, loginDTO.getM_naver());
                    try {
                        String succ = mySnsUpdate.execute().get().trim();
                        MyPageInfoActivity myPageInfoActivity = new MyPageInfoActivity();
                        if(succ.equals("1")){
                            loginDTO.setM_kakao(kakaoId);
