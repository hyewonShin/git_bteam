...
public class FreeBoardDelete extends AsyncTask<Void, Void, String> {

    int f_num;
    String f_file;
    String result;

    public FreeBoardDelete(int f_num, String f_file) {
        this.f_num = f_num;
        this.f_file = f_file;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/app/freeBoardDelete";
