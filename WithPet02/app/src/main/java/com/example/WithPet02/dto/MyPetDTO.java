...
public class MyPetDTO implements Serializable {
    private int p_num;
    private String p_name, p_tel, p_animal, p_a_animal, p_birth, p_gender, p_pic;

    public MyPetDTO() {}

    public MyPetDTO(int p_num, String p_name, String p_tel, String p_animal, String p_a_animal, String p_birth, String p_gender, String p_pic) {
        this.p_num = p_num;
        this.p_name = p_name;
        this.p_tel = p_tel;
