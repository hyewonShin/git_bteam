...
public class MySnsUpdate extends AsyncTask<Void, Void, String> {

    String m_tel, m_kakao, m_naver;
    String result;

    public MySnsUpdate(String m_tel, String m_kakao, String m_naver) {
        this.m_tel = m_tel;
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/app/anSnsUpdate";
            ...
            Log.d("main:MySnsUpdate", result);

            inputStream.close();

        } catch (Exception e){
            Log.d("main:MySnsUpdate", e.getMessage());
            e.printStackTrace();
        } finally {
            if(httpEntity != null){
                httpEntity = null;
